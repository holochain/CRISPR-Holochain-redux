...
module.exports = (scenario, conductorConfig) => {
  scenario("create_origin", async (s, t) => {
    ...
    t.deepEqual(read_origin_result.Ok.title, 'Title first origin')
  ...
  scenario("list_origins", async (s, t) => {
    ...
    await alice.call("origins", "origins", "create_origin", {"base": "testbase", "origin_input" : {"uuid":uuidv4(), "title":"Title first origin", "content": "Content", "order": 1}})
	  await alice.call("origins", "origins", "create_origin", {"base": "testbase", "origin_input" : {"uuid":uuidv4(), "title":"Title second origin", "content": "Content", "order": 1}})
    await alice.call("origins", "origins", "create_origin", {"base": "testbase", "origin_input" : {"uuid":uuidv4(), "title":"Title third origin", "content": "Content", "order": 1}})
    await alice.call("origins", "origins", "create_origin", {"base": "testbase", "origin_input" : {"uuid":uuidv4(), "title":"Title fourth origin", "content": "Content", "order": 1}})
    await s.consistency()
