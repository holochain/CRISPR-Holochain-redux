...
const BUBBLES_ANCHOR_TYPE: &str = "list_Bubbles";
const BUBBLE_ENTRY_LINK_TYPE: &str = "Bubble_link";
const BUBBLE_ENTRY_NAME: &str = "Bubble";
...
impl Bubble {
    pub fn new(address: Address, entry: BubbleEntry) -> ZomeApiResult<Bubble> {
        Ok(Bubble{
            id: address.clone(),
...
impl Bubble {
    pub fn existing(id: Address, created_at: Iso8601, address: Address, entry: BubbleEntry) -> ZomeApiResult<Bubble> {
        Ok(Bubble{
            id: id.clone(),
...
pub fn definition() -> ValidatingEntryType {
    entry!(
        name: BUBBLE_ENTRY_NAME,
        description: "The entry with the content.",
        sharing: Sharing::Public,
        validation_package: || {
            hdk::ValidationPackageDefinition::Entry
        },
        validation: | validation_data: hdk::EntryValidationData<BubbleEntry>| {
        ...
        links: [
            from!(      
                ...
                link_type: BUBBLE_ENTRY_LINK_TYPE,
                validation_package: || {
                    hdk::ValidationPackageDefinition::Entry
                },
