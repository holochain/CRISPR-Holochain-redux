...
pub fn validate_entry_create(entry: BubbleEntry, validation_data: hdk::ValidationData) -> Result<(), String> {
...
pub fn validate_entry_modify(new_entry: BubbleEntry, old_entry: BubbleEntry, old_entry_header: ChainHeader, validation_data: hdk::ValidationData) -> Result<(), String> {
...
pub fn validate_entry_delete(old_entry: BubbleEntry, old_entry_header: ChainHeader, validation_data: hdk::ValidationData) -> Result<(), String> {
