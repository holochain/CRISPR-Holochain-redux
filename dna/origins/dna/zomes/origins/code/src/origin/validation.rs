...
pub fn validate_entry_create(entry: OriginEntry, validation_data: hdk::ValidationData) -> Result<(), String> {
...
pub fn validate_entry_modify(new_entry: OriginEntry, old_entry: OriginEntry, old_entry_header: ChainHeader, validation_data: hdk::ValidationData) -> Result<(), String> {
...
pub fn validate_entry_delete(old_entry: OriginEntry, old_entry_header: ChainHeader, validation_data: hdk::ValidationData) -> Result<(), String> {
