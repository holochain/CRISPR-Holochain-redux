...
pub fn validate_entry_create(entry: WebsiteEntry, validation_data: hdk::ValidationData) -> Result<(), String> {
...
pub fn validate_entry_modify(new_entry: WebsiteEntry, old_entry: WebsiteEntry, old_entry_header: ChainHeader, validation_data: hdk::ValidationData) -> Result<(), String> {
...
pub fn validate_entry_delete(old_entry: WebsiteEntry, old_entry_header: ChainHeader, validation_data: hdk::ValidationData) -> Result<(), String> {
