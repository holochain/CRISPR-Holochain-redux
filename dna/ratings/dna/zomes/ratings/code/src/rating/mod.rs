...
const RATINGS_ANCHOR_TYPE: &str = "list_ratings";
const RATING_ENTRY_LINK_TYPE: &str = "rating_link";
...
impl Rating {
    pub fn new(address: Address, entry: RatingEntry) -> ZomeApiResult<Rating> {
        Ok(Rating{
            id: address.clone(),
...
impl Rating {
    pub fn existing(id: Address, created_at: Iso8601, address: Address, entry: RatingEntry) -> ZomeApiResult<Rating> {
        Ok(Rating{
            id: id.clone(),
...
pub fn definition() -> ValidatingEntryType {
    entry!(
        name: RATING_ENTRY_NAME,
        description: "The entry with the content.",
        sharing: Sharing::Public,
        validation_package: || {
            hdk::ValidationPackageDefinition::Entry
        },
        validation: | validation_data: hdk::EntryValidationData<RatingEntry>| {
        ...
        links: [
            from!(      
                ...
                link_type: RATING_ENTRY_LINK_TYPE,
                validation_package: || {
                    hdk::ValidationPackageDefinition::Entry
                },
