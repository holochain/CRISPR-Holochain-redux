...
pub fn validate_entry_create(entry: RatingEntry, validation_data: hdk::ValidationData) -> Result<(), String> {
...
pub fn validate_entry_modify(new_entry: RatingEntry, old_entry: RatingEntry, old_entry_header: ChainHeader, validation_data: hdk::ValidationData) -> Result<(), String> {
...
pub fn validate_entry_delete(old_entry: RatingEntry, old_entry_header: ChainHeader, validation_data: hdk::ValidationData) -> Result<(), String> {
