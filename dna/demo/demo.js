...
// const bubblesDnaPath = path.join(__dirname, "../bubbles/dna/dist/dna.dna.json")
...
// const editorBubblesDna = Config.dna(bubblesDnaPath, 'bubbles-test', { uuid: uuidv4() })
...
// const philsBubblesDna = Config.dna(bubblesDnaPath, 'bubbles-test', { uuid: uuidv4() })
// const groupBubblesDna = Config.dna(bubblesDnaPath, 'bubbles-test', { uuid: uuidv4() })
...
// const grantsConductorConfig = Config.gen({'6261170b-2064-4920-be43-98cc7ca1d68b': editorOriginsDna, '41553681-4c82-4c8c-87bb-ae2a3d2ba4cc': editorBubblesDna, '4b7641fe-145d-4217-9768-1e0bff70fdf5': tagsDna, 'ef5ba968-0048-4135-b831-a86b615a89b2': holochainProjectsDna, '01526dbb-17f7-42d4-8a26-01270b50eb73': clientProjectsDna, '15f5c748-e611-47c7-9d1b-7651e5c16d17': personalProjectsDna, '68342fe4-c2e3-4568-836e-421722757c84': personalProjectsKanbanDna, '6025b761-26e0-42c2-ad96-8bdc1ce00c33': personalProjectsNotesDna, '1b94be13-632b-4924-aa20-8f67113d7b9a': personalProjectsTasksDna,  '57c01ed8-30ae-4fca-b6f9-40192821fed2': originsDna, '164449a2-e7d4-47dc-acc8-2fe317b8d9fe': originsMatesDna, '95569e2e-0de2-4073-8a7d-579f87534c04': kanbanDna, 'a23de7fe-bff7-4e6e-87f0-f4c44d038888': notesDna, 'e1289ae4-0611-4c5c-b1fa-5b4ed0b8c67a': tasksDna, fields: fieldsDna, personalinformation: philsPersonalInformationDna, '0d765fcf-118f-4122-8f03-f5f9ba74e7fa': philsBubblesDna}, { network: network, logger: logger })
...
orchestrator.registerScenario("Set up Holochain for all players, DHTs and entries", async (s, t) => {
  ...
  // const editorBubblesProfile = await phil.call("41553681-4c82-4c8c-87bb-ae2a3d2ba4cc", "bubbles", "create_profile", {"base": "", "profile_input" : {"agentId":"", "avatar": base64_encode('./assets/philip.beadle.png'), "handle": "Phil"}})
  // console.log('editorBubblesProfile', editorBubblesProfile)
  ...
  // const philPrivateBubblesProfile = await phil.call("0d765fcf-118f-4122-8f03-f5f9ba74e7fa", "bubbles", "create_profile", {"base": "", "profile_input" : {"agentId":"", "avatar": base64_encode('./assets/philip.beadle.png'), "handle": "Phil"}})
  // console.log('philPrivateBubblesProfile', philPrivateBubblesProfile)

  // const philBubblesProfile = await phil.call("0098d2a1-5668-4a5a-8ef8-503d58dd38ce", "bubbles", "create_profile", {"base": "", "profile_input" : {"agentId":"", "avatar": base64_encode('./assets/philt3r.png'), "handle": "philip.bubble"}})
  // console.log('philBubblesProfile', philBubblesProfile)
  // const markBubblesProfile = await mark.call("0098d2a1-5668-4a5a-8ef8-503d58dd38ce", "bubbles", "create_profile", {"base": "", "profile_input" : {"agentId":"", "avatar": base64_encode('./assets/mark.keenan.jpg'), "handle": "mark.keenan"}})
  // console.log('markBubblesProfile', markBubblesProfile)
  // const rudyBubblesProfile = await rudy.call("0098d2a1-5668-4a5a-8ef8-503d58dd38ce", "bubbles", "create_profile", {"base": "", "profile_input" : {"agentId":"", "avatar": base64_encode('./assets/rudy.jpeg'), "handle": "Rudy"}})
  // console.log('rudyBubblesProfile', rudyBubblesProfile)
  // const lucyBubblesProfile = await lucy.call("0098d2a1-5668-4a5a-8ef8-503d58dd38ce", "bubbles", "create_profile", {"base": "", "profile_input" : {"agentId":"", "avatar": base64_encode('./assets/lucy.jpg'), "handle": "Lucy"}})
  // console.log('lucyBubblesProfile', lucyBubblesProfile)
